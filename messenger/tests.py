...
class ThreadTestCase(TestCase):
    def setUp(self):
        ...
        # Create an instance of the Model Thread in order to use it for add values
        # to the fields users and messages whose are ManyToMany fields
    ...
    def test_add_messages_to_thread(self):
        ...
        # Show the conversation between user1 and user2
